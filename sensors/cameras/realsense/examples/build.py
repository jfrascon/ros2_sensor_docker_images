...
if __name__ == '__main__':
    ...
    realsense_dir = examples_dir.parent
    cameras_dir = realsense_dir.parent
    sensors_dir = cameras_dir.parent
    project_dir = sensors_dir.parent
    base_docker_files_dir = project_dir.joinpath('base_docker_files')

    parser = argparse.ArgumentParser(
        description=('Script to build a Docker image to run the ROS2 driver for the Realsense cameras.\n\n'),
    ...
    default_img_id = 'realsense:<ros_distro>'
