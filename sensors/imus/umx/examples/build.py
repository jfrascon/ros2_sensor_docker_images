...
if __name__ == '__main__':
    ...
    umx_dir = examples_dir.parent
    imus_dir = umx_dir.parent
    sensors_dir = imus_dir.parent
    project_dir = sensors_dir.parent
    base_docker_files_dir = project_dir.joinpath('base_docker_files')

    parser = argparse.ArgumentParser(
        description=('Script to build a Docker image to run the ROS2 driver for the UM6 and UM7 IMU sensors.\n\n'),
    ...
    shutil.copy2(umx_dir.joinpath('sensor.launch.py'), tmp_context_dir.joinpath('sensor.launch.py'))
