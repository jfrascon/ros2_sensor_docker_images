...
if __name__ == '__main__':
    ...
    robosense = examples_dir.parent
    lidars_dir = robosense.parent
    ...
    dockerfile = robosense.joinpath('Dockerfile')
    ...
    shutil.copy2(robosense.joinpath('install.sh'), tmp_context_dir.joinpath('install.sh'))
    shutil.copy2(robosense.joinpath('compile.sh'), tmp_context_dir.joinpath('compile.sh'))
    shutil.copy2(robosense.joinpath('eut_sensor.launch.py'), tmp_context_dir.joinpath('eut_sensor.launch.py'))
