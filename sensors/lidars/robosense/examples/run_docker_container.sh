...
# This script launches the RoboSense example container using Docker Compose.
...
print_banner_text "=" "Launching RoboSense in a Docker container of image '${IMG_ID}' in '${mode}' mode"
