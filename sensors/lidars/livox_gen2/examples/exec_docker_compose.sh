...
# Example:
#  ./<this_script> livox_gen2_lidar:humble 1 automatic --env ROS_LOCALHOST_ONLY=1
...
# Example:
#  ./<this_script> livox_gen2_lidar:jazzy 2 manual \
...
if [ "${example}" == "1" ]; then
    export JSON_FILE="example_${example}.front_livox_mid360.json"
    export YAML_FILE="example_${example}.front_livox_mid360.yaml"
elif [ "${example}" == "2" ]; then
    export JSON_FILE="example_${example}.front_back_livox_mid360.json"
    export YAML_FILE="example_${example}.front_back_livox_mid360.yaml"
else
