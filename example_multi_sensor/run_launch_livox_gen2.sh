...
topic_remappings="${LIVOX_TOPIC_REMAPPINGS:-${TOPIC_REMAPPINGS:-}}"
node_options="${LIVOX_NODE_OPTIONS:-${NODE_OPTIONS:-}}"
logging_options="${LIVOX_LOGGING_OPTIONS:-${LOGGING_OPTIONS:-}}"
